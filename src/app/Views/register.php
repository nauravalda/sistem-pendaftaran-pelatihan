    ...
    <div class="w-full h-screen p-24 px-44 bg-on-primary-fixed justify-start items-start inline-flex">
        <div class="grow shrink rounded-3xl shadow-2xl self-stretch inline-flex">
            ...
            <div class="px-10 rounded-r-3xl py-5 bg-white w-full h-full items-center justify center">
                ...
                <div class="my-2">
                    <label for="name" class="block text-sm font-medium leading-6 text-zinc-900">Full Name</label>
                    <div class="relative rounded-md shadow-sm">
                        ...
                        <input type="name" name="name" id="name" class="block w-full rounded border border-zinc-500 py-1.5 pl-12 pr-0 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-zinc-600 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 h-12" placeholder="Enter your full name">
